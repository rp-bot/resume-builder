...
\begin{center}
    ...
    % $|$
     \hspace{.5pt} {\underline{dfgjdgfjgfdjfgj}}
    $|$
...
hello innovator with expertise in AI, full-stack development, and music technology. Specialized in data engineering for large audio datasets, machine learning models, and audio processing solutions with demonstrated success in research and client-facing environments. 
...
\resumeSubHeadingListStart
  \resumeItem{
    \small{
      \textbf{prgramming:} python, \textbf{javascript}, rust, C++\\[-5pt]
    }
  }
...
\section{Professional Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {adhjksf}{sdgsfdg $|$ jan2025 - present}
      {sdgsgh}
      \resumeItemListStart
        \resumeItem{skidjhsdfjkgbjkldsfgi}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
  \vspace{-15pt}
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    \resumeEducationHeading
      {Purdue University}{Indianapoliss, IN $|$ may 2024}
